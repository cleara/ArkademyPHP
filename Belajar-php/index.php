...
<body>
    <nav>
        ...
        <ul id="menu">
            <li><a href="https://www.youtube.com/channel/UCOQSsumfrX-oIO9e6eHxSuw?view_as=subscriber">YOUTUBE</a></li>
            <li><a href="https://www.instagram.com/clearaps/">INSTAGRAM</a></li>
            <li><a href="https://www.smktelkom-mlg.sch.id/">MY SCHOOL</a></li>
    ...
    <section id="box-profile">
        ...
        <div class="photo" 
           style="background-image: url(assets/IMG/IMG-20180805-WA0024.jpg);"></div>
        </div>
        <div class="description">
            <h1 id="pName"><?php echo $nama; ?></h1>
            <p id="pRole"><?php echo $role; ?></p>
            <a href="#input-form" class="button bg-green" onclick="editfrom()">Edit</a>
...
<section id="input-form">
    ...
    <div class="form">
        ...
        <label>Name</label>
        <input id="inpNama" type="text" name="name">
    </div>  
    <div class="form">
        <label>Role</label>
...
<script>
    ...
    function editfrom(){
        ...
        var availabe = document.getElementById("pAvailable").innerHTML;
